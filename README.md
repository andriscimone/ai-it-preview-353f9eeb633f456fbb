...
La pagina segreta `spooky-timeline.html` confronta le timeline speculative di *AI 2027*, *Situational Awareness* e *AI 2040*, poi rende esplorabili i cinque piani di *AI 2040* e dodici futuri alternativi. `spooky-timeline.js` gestisce tab, scorrimento e indice attivo; `SPOOKY_TIMELINE.md` documenta lo sblocco e la verifica. Le date restano separate per fonte e i futuri del video non vengono presentati come previsioni o scenari probabilistici.
