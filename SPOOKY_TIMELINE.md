...
5. Usa “Entra nell'accelerazione”: il salto deve fermarsi all'inizio della nuova sezione, sotto l'header fisso.
6. Controlla che tutti e tre i grafici siano leggibili, caricati e apribili a piena risoluzione; i collegamenti alle fonti devono aprire Anthropic o OpenAI in una nuova scheda.
7. Apri il registro: deve mostrare 43 eventi, i collegamenti 2025 e 2026 e tutte le fonti cliccabili; richiudilo anche con la tastiera.
8. Cambia le tre timeline anche con le frecce della tastiera e scorri le carte in orizzontale.
9. Segui entrambi i rami dell'albero: ogni esito deve mostrare il collegamento e aprire la scheda con lo stesso numero; il raccordo “12 esiti → 12 racconti” deve portare all'inizio delle descrizioni.
10. In ognuno dei dodici futuri apri “Entra nello scenario”: deve comparire il racconto completo con il riferimento alle pagine del libro; richiudilo anche con la tastiera.
11. Ricarica la timeline: devi tornare alla homepage.
12. Ripeti su mobile e controlla che manifesto, circuito, grafici, registro, tendine e carte restino leggibili senza scorrimento laterale della pagina.
